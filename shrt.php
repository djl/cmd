...
<body>
    ...
    <?php else: ?>
        ...
        <p class="left"><span class="out">bookmarklet: </span><a id="link" href="javascript:shrt();function%20shrt(){var%20nw=false;var%20c=window.prompt('Type%20`help`%20for%20a%20list%20of%20commands:');var%20h='';try{h=escape(window.location.hostname);}catch(e){h='about:blank'};var%20u=escape(window.location);var%20t=escape(document.title);if(c){if(c.substring(0,1)=='%20'){nw=true;}c=escape(c);var%20url='<?php echo url() ?>?t='+t+'&c='+c+'&h='+h+'&u='+u+'&f=http://shrt.dev/shrts.txt';if(nw){var%20w=window.open(url);w.focus();}else{window.location.href=url;};};};">shrt</a></p>
    <?php endif; ?>
</body>
</html>